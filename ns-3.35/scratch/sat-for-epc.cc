...
main (int argc, char *argv[])
{
    ...
    CommandLine cmd;
    cmd.AddValue ("TcpVariant", "Transport protocol to use: TcpBbr, TcpPCC, TcpCubic, TcpCopa", transport_prot);
    ...
    transport_prot = string("ns3::") + transport_prot ;
    Config::SetDefault("ns3::TcpL4Protocol::SocketType", TypeId::LookupByName (transport_prot)) ;
